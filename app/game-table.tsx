...
import { Ban, Banknote, Clock3, Download, HandHeart, Music2, Pause, Play, Radio, RotateCcw, ShieldCheck, Siren, Target, Volume2, VolumeX, Zap } from "lucide-react";
...
const actionMeta: Record<ActionId, { label: string; hint: string; icon: typeof Zap }> = {
  ...
  lockdown: { label: "LOCKDOWN", hint: "6 secs", icon: Siren },
